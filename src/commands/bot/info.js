        ...
        .then(async results => {
            ...
            client.embed({
                ...
                fields: [
               {
                ...
                {
                    name: "🔧┆Bot owner",
                    value: `<@!721743146815586404> `,
                    inline: true,
                },
                {
                    name: "🔧┆Bot developer",
                    value: `<@!721743146815586404> <@!526677939312656385>`,
                    inline: true,
                },
                {
                    name: "💻┆Commands",
                ...
                {
                    name: "🔗┆Links",
                    value: `[Support server!](https://discord.com/api/oauth2/authorize?client_id=1180563331027832872&permissions=8&response_type=code&redirect_uri=https%3A%2F%2Fdiscord.gg%2FkXFkwphDfw&scope=bot+identify)
[Add me!](https://discord.com/api/oauth2/authorize?client_id=1180563331027832872&permissions=8&response_type=code&redirect_uri=https%3A%2F%2Freplit.com%2F%40AsthmaTeam%2FAsthmahusband&scope=bot+identify)`,
                    inline: false,
                }],
                type: 'editreply'
            }, interaction)
