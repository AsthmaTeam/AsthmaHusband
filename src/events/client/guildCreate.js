    ...
    try {
        ...
        client.embed({
            ...
            },
            {
                ...
                value: `You can DM <@721743146815586404> for support or joining the [Support Server](https://dsc.gg/uranusplanet)`,
                inline: false,
            },
            {
            ...
            {
                name: "📨┆Invite the bot!",
                value: `Invite the bot to click [Here](https://dsc.gg/AsthmaTeam)`,
                inline: false,
            },
            ],
            components: [row], 
